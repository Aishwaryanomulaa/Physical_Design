...
![RISC-V RTL and Synthesis](screenshots/05_risc_v_rtl_synthesis.png)
...
![Software to Hardware](screenshots/04_software_to_hardware.png)
...
![Open Source EDA](screenshots/06_open_source_eda.png)
...
![RTL to GDS](screenshots/07_rtl2gds.png)
...
![OpenLANE Flow](screenshots/03_openlane_flow.png)
...
![OpenLANE Detailed Flow](screenshots/08_openlane_detailed_flow.png)
...
![OpenLANE Directory](screenshots/09_openlane_directory.png)
...
![Design Preparation](screenshots/10_design_prep.png)
...
![Synthesis Results](screenshots/11_synthesis_results.png)

### Screenshot - Synthesis Reports

![Synthesis Reports](screenshots/14_synthesis_reports.png)
...
![Synthesis Cells](screenshots/12_synthesis_cells.png)
...
![Synthesis Area](screenshots/13_synthesis_area.png)
...
All screenshots documenting the practical work and lecture concepts are available in the [`screenshots`](screenshots/) directory.
